...
import Display.ButtonMenu;

import java.awt.image.BufferedImage;
import java.util.Arrays;

import Communication.AD_Parameter;
import Controls.AbstractOsziComponent;
...
//BUttons werden nicht richtig gesetzt
    ...
    /************* Button variables *************/
	private AbstractOsziComponent component=null;
    ...
    public ButtonMenu buttonMenu = null;
    ...
    Settings(int buttonNo, String headerText) {
        ...
        this.type = ButtonType.EVENT_BUTTON;
        this.isSetting = false;
    }
    ...
    Settings(int buttonNo, String headerText, Settings buttonArrayId) {
        ...
        this.type = ButtonType.REF_BUTTON;
        this.isSetting = false;
    }
    ...
    Settings(int buttonNo, String headerText, String setting, String unit) {
        ...
        this.setting = setting;
        this.unit = unit;
        this.type = ButtonType.VALUE_BUTTON;
    }
    ...
    Settings(int buttonNo, String headerText, String setting) {
        ...
        this.headerText = headerText;
        this.setting = setting;
        this.type = ButtonType.CHECKBOX_BUTTON;
    }
    ...
    Settings(int buttonNo, String headerText, String[] menuList, Settings[] buttonArrayIds) {
        ...
        buttonMenu = new ButtonMenu(this, Arrays.asList(menuList), buttonArrayIds);
        this.type = ButtonType.MENU_BUTTON;
    }
    ...
    Settings(int buttonNo, WaveForms form1, WaveForms form2, WaveForms form3, String setting) {
        ...
        //load image in button class ?
        for(int i = 0; i < 3; i++) {
            if(this.waves[i].isImage()) {
                this.waveFormsImages[i] = this.waves[i].getImage();
            }
        }

        this.setting = setting;
        this.type = ButtonType.TRIPLE_CHECK_BUTTON;
    }


    /* get and set proberties */
    //getter methods
    public String get() {
        return this.setting;
    }
    ...
    public int getInt() {
        try {
            ...
            e.printStackTrace();
            System.err.print("Settings." + this.name() + "\n");
            return 0;
        }
    }
...
/*    public String getScienceNotation() {
        return decFormat.format(this.getDouble());
    }*/
...
public String getScienceNotation()
{
	return AD_Parameter.getValueInScienceNotation("###.##",this.getDouble());
}

public static String getScienceNotation(double value)
{
	return AD_Parameter.getValueInScienceNotation("###.##",value);
}

    private void printDebugInfo(String str) {
        //if debug == true then print
        System.out.print("Debug: "+this.name() + " = " + str + "\n");
    }

    //setter methods
    public void set(int value) {
        this.setting = String.valueOf(value);
        printDebugInfo(this.setting);
    ...
    public void set(boolean value) {
        this.setting = Boolean.toString(value);
        printDebugInfo(this.setting);
        if(component!=null) component.repaint();
    }
    ...
    public void setHeaderText(String value) {
        ...
        printDebugInfo(this.headerText);
        if(component!=null) component.repaint();
    }
    
    public void setConnectedComponent(AbstractOsziComponent component){
    	this.component=component;
    }
    
    public static Settings getEnumByString(String code){
